                     ...
                     <div class="list-inline">
                        <div class="list-inline-item me-5">
                           <a href="pages/shop-wishlist.html" class="text-muted position-relative">
                              ...
                              <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-success">  5
                        ...
                        <div class="list-inline-item me-5 me-lg-0">
                           <a class="text-muted position-relative" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" href="#offcanvasExample" role="button" aria-controls="offcanvasRight">
                              ...
                              <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-success">  1
                                 <span class="visually-hidden">unread messages</span>
                              </span>
                           </a>
                        </div>
            ...
            <div class="container">
               <div class="offcanvas offcanvas-start" tabindex="-1" id="navbar-default" aria-labelledby="navbar-defaultLabel">
                  <div class="offcanvas-header pb-1">
                     <a href="index.html"><img src="assets/images/logo/logo1.png" height="80px" width="100px" alt="eCommerce HTML Template" /></a>
                  ...
                  <div class="offcanvas-body">
                    ...
                    <ul class="navbar-nav align-items-center">
                           ...
                           <li class="nav-item dropdown w-100 w-lg-auto">
                              <a class="nav-link toggle" href="aboutus.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">About Us</a>
                             
                           </li>
                           <li class="nav-item w-100 w-lg-auto">
                              <a class="nav-link toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Stores</a>
                           </li>
                           <li class="nav-item  w-100 w-lg-auto dropdown-fullwidth">
                              <a class="nav-link toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Mega menu</a>
                           </li>
                           <li class="nav-item dropdown w-100 w-lg-auto">
                              <a class="nav-link toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Pages</a>
                           </li>
                           <li class="nav-item dropdown w-100 w-lg-auto">
            ...
            <div class="modal-content p-4">
               ...
               <div class="modal-body">
                  <form class="needs-validation" novalidate>
                     ...
                     <button type="submit" class="btn btn-info" type="submit">Sign Up</button>
                  </form>
               </div>
