         ...
         <section class="mt-8">
            <div class="container">
               <div class="hero-slider">
                  <div style="background: url(assets/images/slider/ad-banner-1.jpg) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
                     ...
                     <div class="card card-product">
                        <div class="card-body">
                         ...
                         <h2 class="fs-6"><a href="pages/shop-single.html" class="text-inherit text-decoration-none"><?= htmlspecialchars($pro['pname']) ?></a></h2>
                              <div>
                                 <span class="text-dark"><?= htmlspecialchars($pro['price']) ?></span>
                                 <span class="text-dark"><?= htmlspecialchars($pro['stock']) ?></span><br>
                              </div><br>
                              <div>
                                 <a href="buynow.php" class="btn btn-info btn-sm"> 
                                    Buy Now
                                 </a>
