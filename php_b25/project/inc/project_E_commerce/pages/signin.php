...
<!-- Mirrored from freshcart.codescandy.com/pages/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Oct 2024 07:27:49 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8" />
                ...
                <?php endif; ?>
                     ...
                     <form class="needs-validation" method="post">
                        <div class="row g-3">
                           ...
                           <!-- btn -->
                           <div class="col-12 d-grid"><button type="submit" class="btn btn-info">Sign In</button></div>
                           <!-- link -->
                           <div>
