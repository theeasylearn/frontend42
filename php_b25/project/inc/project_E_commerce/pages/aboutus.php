                  ...
                  <div class="offset-lg-1 col-lg-10 col-12">
                     <div class="row align-items-center mb-14">
                        ...
                        <div class="col-md-6">
                           <div>
                              <!-- img -->
                              <img src="../pages/assets/images/about/about-img.jpg" alt="" class="img-fluid rounded" />
                           </div>
                        </div>
                     </div>
                     <!-- row -->
                        ...
                        <div class="col-md-4">
                           ...
                           <div class="card bg-light mb-6 border-0">
                              ...
                              <div class="card-body p-8">
                                 <div class="mb-4">
                                    <!-- img -->
                                    <img src="../pages/assets/images/about/about-icons-1.svg" alt="" />
                                 </div>
                        ...
                        <div class="col-md-4">
                           ...
                           <div class="card bg-light mb-6 border-0">
                              ...
                              <div class="card-body p-8">
                                 <div class="mb-4">
                                    <!-- img -->
                                    <img src="../pages/assets/images/about/about-icons-2.svg" alt="" />
                                 </div>
                        ...
                        <div class="col-md-4">
                           ...
                           <div class="card bg-light mb-6 border-0">
                              ...
                              <div class="card-body p-8">
                                 <div class="mb-4">
                                    <!-- img -->
                                    <img src="../pages/assets/images/about/about-icons-3.svg" alt="" />
                                 </div>
